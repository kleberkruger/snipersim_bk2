/*
 * Generated by /workspaces/sniper/benchmarks/parsec/parsec-2.1/pkgs/tools/cmake/src/bootstrap
 * Version:     $Revision: 1.113 $
 *
 * Source directory: /workspaces/sniper/benchmarks/parsec/parsec-2.1/pkgs/tools/cmake/src
 * Binary directory: /workspaces/sniper/benchmarks/parsec/parsec-2.1/pkgs/tools/cmake/obj/amd64-linux.gcc-sniper/Bootstrap.cmk
 *
 * C compiler:   gcc
 * C flags:      -O3 -funroll-loops -fprefetch-loop-arrays -static-libgcc -Wl,--hash-style=both,--as-needed -DPARSEC_VERSION=2.1 -DENABLE_PARSEC_HOOKS -I/workspaces/sniper/benchmarks/parsec/parsec-2.1/pkgs/libs/hooks/inst/amd64-linux.gcc-sniper/include -I/workspaces/sniper/benchmarks/tools/hooks -I/workspaces/sniper/include -DENABLE_PARMACS
 *
 * C++ compiler: g++
 * C++ flags:    -std=gnu++17 -O3 -funroll-loops -fprefetch-loop-arrays -fpermissive -fno-exceptions -static-libgcc -Wl,--hash-style=both,--as-needed -DPARSEC_VERSION=2.1 -DENABLE_PARSEC_HOOKS -I/workspaces/sniper/benchmarks/parsec/parsec-2.1/pkgs/libs/hooks/inst/amd64-linux.gcc-sniper/include -I/workspaces/sniper/benchmarks/tools/hooks -I/workspaces/sniper/include -fexceptions
 *
 * Make:         /usr/bin/make
 *
 * Sources:
